...
if (require.main === module) {
  ...
  if (args.length < 1) {
    ...
    console.log('\nTransport types:');
    console.log('  auto <url>                Auto-detect transport type (recommended for HTTP servers)');
    ...
    console.log('\nExample:');
    console.log('  mcp-test-framework-advanced auto http://localhost:3000/mcp --verbose');
  ...
  (async () => {
    ...
    if (verified) {
      ...
      console.error('   Try specifying transport manually: sse or streamableHttp');
      process.exit(1);
    }
  }
